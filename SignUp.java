...
public class SignUp extends JFrame
{
	...
	JButton b1;
	Color brown = Color.decode("#5c4102");
	Color yelow=Color.decode("#B29476");
	Color Reg=Color.decode("#181403");
	SignUp()
	{
		f=new JFrame("Burn the cake");
		...
		f.setContentPane(new JLabel(new ImageIcon("D:\\oop JAVA\\cake delivery\\cake.jpg")));
		p2.add(l1); //register
		p1.add(p2);//sub panel
		p3.add(l4);//dash
		p1.add(p3);
